...
variable "network_cidr" {
  type        = string
  description = "catalyst Virtual Network CIDR block"
}
...
variable "public_subnets" {
  description = "Create catalyst Public subnets"
  type        = list(string)
  default     = null
}
variable "public_subnet_ids" {
  description = "Use existing catalyst Public subnet ids"
  type        = list(string)
  default     = null
}
variable "private_subnets" {
  description = "Create catalyst Private subnets"
  type        = list(string)
  default     = null
}
variable "private_subnet_ids" {
  description = "Use existing catalyst Private subnet ids"
  type        = list(string)
  default     = null
}
...
variable "hostname" {
  description = "Hostname of catalyst instance"
}
...
variable "catalyst_bgp_as_num" {
  type        = string
  description = "catalyst Remote BGP AS Number"
}
